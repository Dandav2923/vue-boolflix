...
<template>
    <section>
        <div class="row">
            <div class="col">
                <div class="card bg-dark text-white m-2 container-card">
                    <div v-if="img == null" >
                        <img class="img-not-found" src="https://cdn.download.it/ms/static/images/poster-placeholder.png" alt="">
                    </div>
                    <div v-else>
                        <img 
                        :src="src + img"
                        class="card-img img-film" alt="...">
                    </div>
                        <div class="card-img-overlay">
                            <h2 class="card-title">{{ title }}</h2>
                            <p class="card-text"> Titolo Originale : {{ originalTitle }}</p>
                            <p class="card-text">Paese di origine :
